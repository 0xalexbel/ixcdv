...
function patchFail(strict) {
    return fail(
        new CodeError('iexec-core patch failed.', ERROR_CODES.PKGMGR_ERROR),
        strict);
}
...
export async function patch(dir, setup, options = { strict: false }) {
    ...
    try {
        ...
        await patchBuildInfoIfNeeded(dir, setup, 'src/main/java/com/iexec/core/utils/version/VersionService.java');
